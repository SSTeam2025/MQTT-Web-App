...
public class Filters {
    ...
    public static BufferedImage applyBrightness(BufferedImage img, Integer percent) {
        // Convert percent (-100 to +100) to scale (0.0 to 2.0)
        float scale = (percent != null ? percent : 0) / 100.0f + 1.0f;

        // RescaleOp multiplies each channel by `scale`, no offset
